...
export class RegisterInput implements Partial<User> {
  ...
  @Field()
  @Length(3, 15, { message: "Le nom d'utilisateur doit comporter entre 3 et 15 caractères." })
  ...
  @Field()
  @Length(6, 15, { message: "Le mot de passe doit comporter entre 3 et 15 caractères." })
  password: string;
